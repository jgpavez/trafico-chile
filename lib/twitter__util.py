...
# if the problem us 503 error. Block until the rate limit is reset if a
# rate limiting issue
...
# A template-like function that can get friends or followers depending
# on the function passed into it via func.
...
if __name__ == '__main__': #for ad-hoc testing
    ...
    def _getRemainingHits(t):
        return 0
    t = login()
    makeTwitterRequest(t, t.friends.ids, screen_names = ['SocialWebMinning'])
